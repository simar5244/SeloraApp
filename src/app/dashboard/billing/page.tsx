...
import { BillingTourLauncher } from '@/components/tour/BillingTourLauncher';
...
export default function BillingPage() {
  ...
  const hardcodedPlansData: Plan[] = [
    // Monthly Plans
    {
      ...
      interval: 'month',
      userLimit: 20,
      features: ['20 Users', 'Email and Call Support', 'DIY Onboarding'],
    ...
    },
    {
      ...
      price: 200,
      interval: 'month',
      userLimit: 100, //(this manages the too manny users, max 1,2,3 part of the billing page. purely UI)
      features: ['100 Users', '24/7 Priority Support', 'DIY Onboarding'],
    ...
    },
    {
      ...
      interval: 'month',
      userLimit: 200,
      features: ['200 Users', '24/7 Priority Support', 'Dedicated Account Manager', 'White Glove Onboarding'],
    ...
    // Yearly Plans (with 20% discount compared to monthly)
    {
      ...
      userLimit: 20,
      features: [
        '20 Users', 'Email and Call Support', 'DIY Onboarding', '20% Discount', 'Billed Annually'
      ],
    ...
    },
    {
      ...
      userLimit: 100,
      features: [
        '100 Users', '24/7 Priority Support', 'DIY Onboarding', '20% Discount', 'Billed Annually'
      ],
    ...
    },
    {
      ...
      userLimit: 200,
      features: [
        '200 Users', '24/7 Priority Support', 'Dedicated Account Manager', 'White Glove Onboarding', '20% Discount', 'Billed Annually'
      ],
  ...
  const fetchUserCount = async () => {
    ...
    try {
      ...
      setUserLimit(data.subscription?.userLimit || 100);
      ...
      const formattedSubscription = {
        ...
        userLimit: subData.userLimit || 100,
  ...
  const renderSubscriptionInfo = () => {
    ...
    const displayPlanType = subscription.productName 
      ? formatPlanName(subscription.productName)
        ...
        <div className="relative">
          ...
          <div className="flex items-center mb-3">
            ...
            <span className="font-medium">
              {userCount} / {subscription.userLimit == null ? '100' : subscription.userLimit === Infinity ? 'Unlimited' : subscription.userLimit} users
            </span>
            {limitReached && (
  ...
  return (
    <div className="relative min-h-screen bg-gray-50 py-8 md:py-12 px-4 sm:px-6 lg:px-8 text-gray-900">
      <div className="max-w-3xl mx-auto">
        ...
        {/* Subscription Info */}
        {subscription && (
          <div className="bg-white rounded-xl shadow-xl border border-gray-200 p-6 md:p-8 mb-6" data-tour="current-plan-details">
            <div className="mb-6 flex items-center">
              <div className="bg-purple-100 p-3 rounded-full mr-4 shadow-sm">
                <FaCoins className="h-6 w-6 text-purple-600" />
              </div>
            ...
            <div className="bg-white transition-all duration-300 ease-in-out hidden" data-tour="payment-methods">
              <button 
            ...
            <div className="bg-white transition-all duration-300 ease-in-out mt-4" data-tour="billing-history">
              <button 
        ...
        <div className="bg-white rounded-xl shadow-lg border border-gray-200 transition-all duration-300 ease-in-out mb-6" data-tour="upgrade-plans">
          <button 
          ...
          {showPlans && (
            <div className="p-4 md:p-5 border-t border-gray-200 bg-white">
              ...
              <div className="mt-6 p-4 bg-yellow-50 border border-yellow-200 rounded-lg text-sm text-yellow-800">
                ...
                <span>
                  To change your current plan, please use the "Current Plan" section above. 
                  Subscribing to a plan here will start a new subscription in addition to your current one. 
                  This is typically only needed if you've canceled your subscription and want to renew.
                </span>
              </div>
            </div>
          )}
