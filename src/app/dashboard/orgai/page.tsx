...
import { OrgAITourLauncher } from '@/components/tour/OrgAITourLauncher';

const COMPANY_CODE = process.env.NEXT_PUBLIC_COMPANY_CODE;

export default function WebQueryPage() {
      ...
      <div className="max-w-3xl mx-auto">
        ...
        <div className="text-center mb-10 md:mb-12">
          <h1 className="text-4xl md:text-5xl font-bold text-gray-800 mt-4">
            Org<span className="text-purple-700">AI</span>
          </h1>
        ...
        <div className="bg-white rounded-xl shadow-xl border border-gray-200 p-6 md:p-8 mb-12" data-tour="orgai-query-form">
            ...
            <div>
              ...
              <div className="relative">
                <textarea
                  ...
                  placeholder="e.g., 'What is the team structure in sales division'"
          ...
          {results && !isLoading && (
            <div className="mt-10 pt-8 border-t border-gray-200" ref={resultRef}>
              <div className="mb-5 flex items-center">
                ...
                <h2 className="text-xl md:text-2xl font-semibold text-gray-800">Results</h2>
              </div>
        ...
        <div className="bg-white rounded-xl shadow-lg border border-gray-200 transition-all duration-300 ease-in-out" data-tour="orgai-history">
          <button 
