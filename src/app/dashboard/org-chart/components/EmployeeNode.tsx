...
const EmployeeNode = ({ data, isConnectable }: NodeProps<EmployeeNodeData>) => {
  ...
  return (
    <>
      ...
      <div className="absolute top-0 left-1/2 z-50 pointer-events-auto" style={{
        ...
        boxShadow: '0 0 0 2px rgba(0, 0, 0, 0.5), 0 4px 6px -1px rgba(0, 0, 0, 0.1), 0 2px 4px -1px rgba(0, 0, 0, 0.06)'
      }}>
        <Handle
          type="target"
      ...
      <div className="absolute bottom-0 left-1/2 z-50 pointer-events-auto" style={{
        transform: 'translate(-50%, 50%)',
        width: '10px',
        height: '10px',
        borderRadius: '50%',
      ...
      >
        ...
        {/* Metrics Section */}
        <div className="border-t border-gray-200 pt-2 mt-1 flex-grow flex flex-col">
          {/* Utilization Scores */}
      ...
      {/* Bottom handle - 70% larger than original and more visible */}
