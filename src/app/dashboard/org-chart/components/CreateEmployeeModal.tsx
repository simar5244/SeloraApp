...
const CreateEmployeeModal = ({ isOpen, onClose, onSubmit, departments = [], existingEmployees = [] }: CreateEmployeeModalProps) => {
  ...
  const getUtilizationColor = () => {
    switch (utilizationScore.status) {
      ...
      case 'highly_utilized': return 'bg-red-600';
      case 'overutilized': return 'bg-red-700';
  ...
  return (
    <Dialog open={isOpen} onOpenChange={open => !open && onClose()}>
      ...
      `}</style>
      <DialogContent className="w-[850px] max-w-[95vw] max-h-[90vh] overflow-y-auto p-6" style={{
        maxHeight: 'calc(90vh - 5px)',
        overflowY: 'auto',
        scrollbarWidth: 'thin',
            ...
            <div className="grid grid-cols-2 gap-6">
              ...
              <div className="space-y-2">
                ...
                <div className="flex justify-between">
                  ...
                  <span className="text-xs font-medium text-red-700">Overutilized</span>
                </div>
