...
export default function IntegrationsPage() {
  ...
  return (
    <div className="p-6 bg-gray-100 min-h-screen">
      <h1 className="text-2xl font-bold text-gray-800 mb-6" data-tour="integration-header">ERP Integrations</h1>

      {/* Tab Navigation */}
      <div className="border-b border-gray-200 mb-6" data-tour="integration-tabs">
      ...
      {activeTab === 'configured' && (
        <div>
          ...
          {isLoading ? (
            ...
            <div className="bg-white shadow overflow-hidden rounded-md" data-tour="erp-connections-list">
      ...
      {activeTab === 'available' && (
        <div>
          ...
          <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-3" data-tour="available-integrations">
            {[
              { 
                type: 'SAP_HR', 
                name: 'SAP HR', 
      ...
      {isFormOpen && (
        <div className="fixed inset-0 bg-gray-600 bg-opacity-50 overflow-y-auto h-full w-full z-50 flex items-center justify-center">
          <div className="relative mx-auto p-5 border w-full max-w-md bg-white rounded-md shadow-lg" data-tour="erp-config-form">
            ...
            <form onSubmit={saveConnection} data-tour="erp-form-fields">
              <div className="mb-4" data-tour="erp-system-select">
