...
export default function ProfilePage() {
  ...
  const handleTutorialToggle = (enabled: boolean) => {
    ...
    if (enabled) {
      toast.success('Tutorials Enabled', {
        position: 'top-right',
        duration: 3000,
      });
    } else {
      toast.success('Tutorials Disabled', {
        position: 'top-right',
        duration: 3000,
      });
    }
  ...
  return (
    <div className="max-w-7xl mx-auto py-8 px-4 sm:px-6 lg:px-8">
      ...
      <div className="mb-8 bg-gradient-to-r from-purple-600 to-indigo-600 rounded-xl p-6 shadow-lg" data-tour="profile-information">
      ...
      {loading ? (
        ...
        <Tabs defaultValue="basic-info" value={activeTab} onValueChange={setActiveTab} className="space-y-4">
          <TabsList className="grid grid-cols-4 lg:w-[800px] mx-auto mb-8 p-1 bg-purple-50 rounded-lg">
            <TabsTrigger
              value="basic-info"
                      ...
                      <FormField
                        ...
                        render={({ field }) => (
                          <FormItem>
                            ...
                            <FormControl>
                              <Input {...field} placeholder="Enter manager's name or email" className="border-purple-200 focus:border-purple-400" />
                            </FormControl>
                            <FormDescription className="text-xs text-gray-500">
                  ...
                  <div className="space-y-6">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                      ...
                      <div className="space-y-3">
                        <div className="flex items-center">
                          <Briefcase className="h-5 w-5 text-purple-500 mr-2" />
                          <h3 className="text-sm font-medium text-gray-500">Reports To</h3>
                        </div>
                        <p className="text-base font-medium text-gray-900 pl-7">{user?.reportsTo || '-'}</p>
                      </div>
                    </div>
                  </div>
                )}
              ...
              <CardHeader className="bg-gradient-to-r from-purple-50 to-indigo-50">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <CardDescription className="text-black">Manage your application preferences</CardDescription>
                  </div>
                </div>
              </CardHeader>
                ...
                <div className="space-y-6">
                  <div className="flex items-center justify-between p-4 border border-gray-200 rounded-lg">
                    <div className="flex-1">
                      <h3 className="text-base font-medium text-gray-900">Tutorial Mode</h3>
                      <p className="text-sm text-gray-500 mt-1">
                        Enable or disable tutorial guides across all pages. When disabled, tutorial buttons will be hidden throughout the application.
                      </p>
                    </div>
                    <div className="ml-4">
                      <Checkbox
