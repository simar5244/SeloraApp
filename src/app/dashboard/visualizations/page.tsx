...
import { FaProjectDiagram, FaStar, FaSitemap } from 'react-icons/fa'; // Example icons
    ...
    <div className="container mx-auto p-6 bg-gray-50 min-h-full">
      ...
      <div className="relative z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-3xl mx-auto">
          {/* Org Chart Box */}
          <Card className="hover:shadow-xl transition-shadow bg-white/80 backdrop-blur-sm border-purple-200" data-tour="org-chart-card">
          ...
          <Card className="hover:shadow-xl transition-shadow bg-white/80 backdrop-blur-sm border-indigo-200" data-tour="galaxy-view-card">
