...
import { UserManagementTourLauncher } from '@/components/tour/UserManagementTourLauncher';
...
export default function UserManagementPage() {
  ...
  return (
    <div className="container mx-auto py-8 px-4 bg-gray-50 min-h-screen">
      <div className="text-center mb-10 md:mb-12" data-tour="user-management-header">
