...
export default function ResetPasswordPage() {
  ...
  const [currentStep, setCurrentStep] = useState<'request' | 'verify' | 'complete'>('request');
  ...
  // Clear success message when moving to complete step
  useEffect(() => {
  ...
  const handleRequestSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Stay on same page, just move to verify step
    ...
    <div className="min-h-screen flex bg-white">
      ...
      <div className="w-2/5 flex flex-col px-16 py-8 relative">
        ...
        <div className="flex-1 flex items-center justify-center">
          ...
          <div className="mb-8">
            <h1 className="text-2xl font-light text-gray-900 mb-2">
              {currentStep === 'request' ? 'Reset Password' :
               currentStep === 'verify' ? 'Verify & Set New Password' :
               'Password Reset Complete'}
            </h1>
            <p className="text-sm text-gray-600">
              {currentStep === 'request' ? 'Enter your email to receive a verification code' :
               currentStep === 'verify' ? 'Enter the code and set your new password' :
          ...
          {successMessage && currentStep !== 'complete' && (
          ...
          {currentStep === 'verify' && (
            <form onSubmit={handleVerifySubmit} className="space-y-6">
              <div className="bg-purple-50 border border-purple-200 text-purple-800 p-4 rounded-lg">
                ...
                <p className="mt-1 text-sm">A verification code has been sent to {email}. Please enter it below along with your new password.</p>
              </div>
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-purple-500 focus:border-purple-500 text-gray-900 text-center"
                  placeholder="000000"
                  required
                />
              </div>
          ...
          {currentStep === 'complete' && (
            <div className="space-y-6">
              ...
              <Link
                href="/login"
                className={`w-full py-2.5 px-4 bg-purple-600 hover:bg-purple-700 text-white font-medium rounded-md transition-colors focus:outline-none focus:ring-2 focus:ring-purple-500 focus:ring-offset-2 flex justify-center`}
              >
                Go to Login
              </Link>
            </div>
