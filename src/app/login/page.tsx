...
export default function LoginPage() {
  ...
  // 3 Final Artistic Compositions - Extremely Abstract
  ...
  // Abstract Ocean Depths - Symbolizing waves, oceans, and self-improvement
  ...
  // Keep only the 3 components we're using - removing all unused ones to clean up
          ...
          {!showMFA ? (
            ...
            <form onSubmit={handleMFASubmit} className="space-y-6">
              <div className="bg-purple-50 border border-purple-200 text-purple-800 p-4 rounded-lg">
                ...
                <p className="mt-1 text-sm">A verification code has been sent to your email address. Please enter it below.</p>
              </div>
