        ...
        primaryRiskFactors = Object.entries(factorScores)
          .map(([key, value]) => {
            ...
            return {
              ...
              explanation: `${factorName} is a significant factor in this employee's attrition risk.`
            };
          })
      ...
      primaryRiskFactors = primaryRiskFactors.map((factor: any) => {
        ...
        if (typeof factor === 'string') {
          ...
          return {
            factor: factor,
            score: 0.5,
            explanation: `${factorName} is a contributing factor to this employee's attrition risk.`
          };
        }
