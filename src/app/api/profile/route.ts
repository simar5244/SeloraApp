...
export async function GET(request: NextRequest): Promise<NextResponse> {
  try {
    ...
    return NextResponse.json({
      ...
      totalduration: userObj.totalduration || "",
      currentroleduration: userObj.currentroleduration || "",
      workMode: userObj.workMode || "",
...
export async function PATCH(request: NextRequest): Promise<NextResponse> {
  ...
  try {
    ...
    if (updateData.reportsTo !== undefined) {
      // For backward compatibility, we'll store it in both places
      userUpdate.reportsTo = updateData.reportsTo;
      userUpdate['reports.To'] = updateData.reportsTo;
    }
