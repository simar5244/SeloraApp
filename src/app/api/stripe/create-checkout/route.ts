  ...
  try {
    ...
    const sessionParams: Stripe.Checkout.SessionCreateParams = {
      ...
      success_url: successUrl || 
        `${process.env.NEXT_PUBLIC_APP_URL || 'https://app.seloraa.com'}/company-signup?company_code=${companyCode}${userEmail ? `&email=${encodeURIComponent(userEmail)}` : ''}&session_id={CHECKOUT_SESSION_ID}`,
      cancel_url: cancelUrl || `${process.env.NEXT_PUBLIC_APP_URL || 'https://app.seloraa.com'}/company-signup?company_code=${companyCode}`,
