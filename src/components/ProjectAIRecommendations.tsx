...
const ProjectAIRecommendations: React.FC<ProjectAIRecommendationsProps> = ({
  ...
  const handleApplyRecommendations = (e: React.MouseEvent) => {
    ...
    const recommendedEmployees = recommendations.employees.map((emp: Employee) => ({
      ...
      role: emp.role,
      tasks: emp.tasks,
      hours: emp.hours || '0', // Ensure hours is always set, default to '0' if not provided
    ...
    <div className="bg-white p-4 rounded-md shadow-sm">
      <div className="flex items-center justify-between mb-4">
        <div className="flex items-center">
          <h3 className="text-lg font-medium text-purple-900"></h3>
        </div>
        <button 
      ...
      <Dialog open={profileOpen} onOpenChange={setProfileOpen}>
        <DialogContent className="sm:max-w-[600px] text-black">
          <DialogHeader>
            <DialogTitle className="text-xl">{selectedEmployee?.name || 'Employee Profile'}</DialogTitle>
          </DialogHeader>
          ...
          {selectedEmployee && (
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div>
                ...
                <div className="space-y-3">
                  <div className="mb-4">
                  <div className="text-xs text-gray-500">Job Responsibilities</div>
