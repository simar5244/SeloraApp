...
const OrgChartWelcomeScreen = ({ open, onStart, onClose, isClosing }: { open: boolean; onStart: () => void; onClose: () => void; isClosing?: boolean }) => {
  if (!open) return null;
...
const OrgChartTour = ({ open, onClose }: { open: boolean; onClose: () => void }) => {
  ...
  const steps: TourProps['steps'] = [
    {
      ...
      description: 'Welcome to your interactive organizational chart. Here you can visualize your company structure, explore reporting relationships, and understand team hierarchies.',
      target: () => document.querySelector('[data-tour="org-chart-container"]') as HTMLElement,
      placement: 'left',
    },
    {
      title: 'AI Recommendations',
      description: 'Get AI-powered insights and recommendations for organizational improvements, succession planning, and workforce optimization.',
      target: () => document.querySelector('[data-tour="ai-recommendations"]') as HTMLElement,
      placement: 'bottom',
    },
    {
      title: 'Add Employee',
      description: 'Add new employees to your organizational chart and define their roles, departments, and reporting relationships.',
      target: () => document.querySelector('[data-tour="add-employee"]') as HTMLElement,
      placement: 'bottom',
    },
    {
      title: 'Search Employees',
      description: 'Use the search functionality to quickly find specific employees by name, email, or role within your organization.',
      target: () => document.querySelector('[data-tour="org-search"]') as HTMLElement,
      placement: 'bottom',
    },
    {
      title: 'Department Filter',
      description: 'Switch between different department views to focus on specific areas of your organization and see department-specific structures.',
      target: () => document.querySelector('[data-tour="department-filter"]') as HTMLElement,
      placement: 'bottom',
    },
    {
      title: 'Chart Controls',
      description: 'Use these zoom controls to zoom in and out of your organizational chart for better navigation and detailed viewing.',
      target: () => document.querySelector('[data-tour="chart-controls"]') as HTMLElement,
      placement: 'left',
    },
    {
      title: 'Employee Details',
      description: 'Click on any employee node to view detailed information including role, department, utilization scores, and performance metrics.',
      target: () => document.querySelector('[data-tour="employee-node"]') as HTMLElement,
      placement: 'top',
    },
  ];
  ...
  return (
    <>
      <Tour 
        ...
        type="primary"
        arrow={true}
        rootClassName={`classic-orgchart-tour ${isVisible ? 'tour-fade-in' : ''}`}
        mask={{
      ...
      <style jsx global>{`
        ...
        .classic-orgchart-tour .ant-tour {
          max-width: 220px;
          min-width: 200px;
          border-radius: 12px;
        ...
        .classic-orgchart-tour .ant-tour-inner {
          font-size: 14px;
          padding: 12px;
        ...
        .classic-orgchart-tour .ant-tour-title {
          font-size: 16px;
          font-weight: 700;
          margin-bottom: 6px;
          color: #1f2937;
        ...
        .classic-orgchart-tour .ant-tour-description {
          color: #4b5563;
          line-height: 1.4;
          margin-bottom: 12px;
          font-size: 13px;
        ...
        .classic-orgchart-tour .ant-tour-buttons {
          display: flex;
        ...
        .classic-orgchart-tour .ant-btn-primary {
        ...
        .classic-orgchart-tour .ant-btn-primary:hover {
          background: linear-gradient(135deg, #7c3aed 0%, #6d28d9 100%);
          transform: translateY(-1px);
          box-shadow: 0 4px 8px rgba(139, 92, 246, 0.4);
        }

        .classic-orgchart-tour .ant-btn-default {
        ...
        .classic-orgchart-tour .ant-btn-default:hover {
          border-color: #8b5cf6 !important;
          color: #8b5cf6 !important;
          background: #f9fafb !important;
        }

        .classic-orgchart-tour .ant-tour-close {
          color: #6b7280 !important;
        ...
        .classic-orgchart-tour .ant-tour-close:hover {
          color: #374151 !important;
          background: #f3f4f6 !important;
        }

        .classic-orgchart-tour .ant-tour-arrow {
          border-color: white;
        }

        .classic-orgchart-tour .ant-tour-arrow::before {
          background: white;
          border: 1px solid #e5e7eb;
        }

        /* Ensure the mask covers everything including sidebar */
        .classic-orgchart-tour .ant-tour-mask {
          position: fixed !important;
          top: 0 !important;
          left: 0 !important;
          right: 0 !important;
        ...
        .classic-orgchart-tour [data-tour] {
          position: relative;
          z-index: 1070 !important;
        }

        /* Tour fade-in animation */
        .classic-orgchart-tour.tour-fade-in .ant-tour {
          animation: tourFadeIn 0.5s ease-out forwards;
        }

        .classic-orgchart-tour.tour-fade-in .ant-tour-mask {
...
export function OrgChartTourLauncher() {
  ...
  // Only show on org chart page
  if (!isMounted || !pathname?.includes('/dashboard/org-chart') || !tutorialsEnabled) return null;

  return (
    <>
      {showWelcomePrompt && (
        <OrgChartWelcomeScreen 
          open={true} 
          onStart={startTour}
      ...
      {isTourOpen && (
        <OrgChartTour open={true} onClose={closeTour} />
      )}
    </>
  );
}
