...
export function IntegrationTourLauncher() {
  ...
  useEffect(() => {
    ...
    const hasTakenTour = localStorage.getItem('hasTakenIntegrationTour');
  ...
  const startTour = () => {
    ...
    setIsTourOpen(true);
    localStorage.setItem('hasTakenIntegrationTour', 'true');
  };
  ...
  if (!isMounted || !tutorialsEnabled || !pathname?.includes('/dashboard/integration')) return null;
          ...
          <div className="bg-white rounded-2xl p-8 max-w-md w-full shadow-2xl border border-purple-100">
            <div className="text-center">
              ...
              <p className="text-gray-600 mb-8 leading-relaxed">
                Would you like a quick tour to discover how to connect ERP systems, manage integrations, and synchronize your enterprise data effectively?
              </p>
