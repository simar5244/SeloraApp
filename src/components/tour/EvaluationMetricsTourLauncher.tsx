      ...
      <div className={`bg-white rounded-2xl p-8 max-w-md w-full shadow-2xl border border-purple-100 relative transform transition-all duration-500 ${isClosing ? 'scale-95 opacity-0' : 'scale-100 opacity-100'}`}>
        ...
        <div className="text-center">
          ...
          <h3 className="text-2xl font-bold text-gray-900 mb-4">
            Welcome to Evaluation Metrics
          </h3>
          <p className="text-gray-600 mb-8 leading-relaxed">
            Let's take a quick tour of the evaluation metrics page to help you understand how to track performance, analyze trends, and measure organizational effectiveness.
          </p>
