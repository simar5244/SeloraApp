    ...
    >
      <div className={`bg-white rounded-2xl p-8 max-w-md w-full shadow-2xl border border-purple-100 relative transform transition-all duration-500 ${isClosing ? 'scale-95 opacity-0' : 'scale-100 opacity-100'}`}>
        ...
        <div className="text-center mb-6">
          ...
          <h2 className="text-2xl font-bold text-gray-900 mb-2">Welcome to OrgAI!</h2>
          <p className="text-gray-600 text-sm leading-relaxed">
            Let's take a quick tour to help you leverage AI for organizational insights and predictions
          </p>
        </div>
        ...
        <div className="space-y-4 mb-8">
          <div className="flex items-start space-x-3">
            ...
            <div>
              <h3 className="font-semibold text-gray-900 text-sm">AI-Powered Insights</h3>
              <p className="text-gray-600 text-xs">Get intelligent analysis of your organizational data and trends</p>
            </div>
          </div>
          <div className="flex items-start space-x-3">
            <div className="w-2 h-2 bg-purple-600 rounded-full mt-2 flex-shrink-0"></div>
            <div>
              <h3 className="font-semibold text-gray-900 text-sm">Natural Language Queries</h3>
              <p className="text-gray-600 text-xs">Ask questions about your organization in plain English</p>
            </div>
          </div>
          <div className="flex items-start space-x-3">
            <div className="w-2 h-2 bg-purple-600 rounded-full mt-2 flex-shrink-0"></div>
            <div>
              ...
              <p className="text-gray-600 text-xs">Receive AI-driven predictions and recommendations</p>
            </div>
          </div>
        </div>
