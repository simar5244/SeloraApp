    ...
    >
      <div className={`bg-white rounded-2xl p-8 max-w-md w-full shadow-2xl border border-purple-100 relative transform transition-all duration-500 ${isClosing ? 'scale-95 opacity-0' : 'scale-100 opacity-100'}`}>
        ...
        <div className="text-center mb-6">
          ...
          <h2 className="text-2xl font-bold text-gray-900 mb-2">Welcome to Galaxy View!</h2>
          <p className="text-gray-600 text-sm leading-relaxed">
            Let's take a quick tour to explore your organization's network in an immersive 3D space
          </p>
        </div>
        ...
        <div className="space-y-4 mb-8">
          <div className="flex items-start space-x-3">
            ...
            <div>
              <h3 className="font-semibold text-gray-900 text-sm">3D Network View</h3>
              <p className="text-gray-600 text-xs">Explore organizational connections in immersive 3D space</p>
            </div>
          </div>
          <div className="flex items-start space-x-3">
            <div className="w-2 h-2 bg-purple-600 rounded-full mt-2 flex-shrink-0"></div>
            <div>
              <h3 className="font-semibold text-gray-900 text-sm">Interactive Navigation</h3>
              <p className="text-gray-600 text-xs">Navigate through teams and departments with intuitive controls</p>
            </div>
          </div>
          <div className="flex items-start space-x-3">
            <div className="w-2 h-2 bg-purple-600 rounded-full mt-2 flex-shrink-0"></div>
            <div>
              <h3 className="font-semibold text-gray-900 text-sm">Relationship Mapping</h3>
              <p className="text-gray-600 text-xs">Visualize collaborative relationships and team dynamics</p>
            </div>
          </div>
        </div>
