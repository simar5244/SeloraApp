...
// Define notification types based on requirements
export type NotificationType = 
  | 'project_member'      // A) User added as member/viewer in project/goal
  | 'goal_member'         // A) User added as member/viewer in goal  
  | 'profile_approved'    // B) Profile approved/rejected by supervisor
  | 'feedback_received'   // C) User received feedback
  | 'user_limit_warning'  // D) Admin close to user limit
  | 'admin_new_content';  // E) Admin notification for new goal/project
...
export interface NotificationData {
  ...
  link?: string;
  entityId?: string;
  entityType?: 'project' | 'goal' | 'feedback' | 'profile' | 'billing';
}
